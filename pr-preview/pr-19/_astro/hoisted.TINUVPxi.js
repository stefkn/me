...
}`;function V(e){const o=e.replace("#","");return[parseInt(o.slice(0,2),16)/255,parseInt(o.slice(2,4),16)/255,parseInt(o.slice(4,6),16)/255]}function X(e,o,n){const i=e.createShader(o);return i?(e.shaderSource(i,n),e.compileShader(i),e.getShaderParameter(i,e.COMPILE_STATUS)?i:(console.error("[hero3d] shader compile error:",e.getShaderInfoLog(i)),e.deleteShader(i),null)):null}function yt(e,o,n){const i=e.createProgram();return i?(e.attachShader(i,o),e.attachShader(i,n),e.linkProgram(i),e.getProgramParameter(i,e.LINK_STATUS)?i:(console.error("[hero3d] program link error:",e.getProgramInfoLog(i)),e.deleteProgram(i),null)):null}function xt(e,o,n,i){const t=e.getContext("webgl2",{alpha:!0,antialias:!1,powerPreference:"low-power"});if(!t)return null;const a=X(t,t.VERTEX_SHADER,bt),c=X(t,t.FRAGMENT_SHADER,vt);if(!a||!c)return null;const s=yt(t,a,c);if(!s)return null;t.useProgram(s);const h={resolution:t.getUniformLocation(s,"u_resolution"),time:t.getUniformLocation(s,"u_time"),colors:t.getUniformLocation(s,"u_colors[0]"),accent:t.getUniformLocation(s,"u_accent"),alpha:t.getUniformLocation(s,"u_alpha"),scroll:t.getUniformLocation(s,"u_scroll")},g=[];for(let l=0;l<4;l++){const d=o[l]??"#000000",[p,m,H]=V(d);g.push(p,m,H)}t.uniform3fv(h.colors,new Float32Array(g));const[u,f,r]=V(n);return t.uniform3f(h.accent,u,f,r),t.uniform1f(h.alpha,i),t.disable(t.BLEND),{resize(l,d){const p=Math.max(1,Math.round(l*$)),m=Math.max(1,Math.round(d*$));e.width=p,e.height=m,t.viewport(0,0,p,m),t.uniform2f(h.resolution,p,m)},render(l,d){t.useProgram(s),t.uniform1f(h.time,l),t.uniform1f(h.scroll,d),t.drawArrays(t.TRIANGLES,0,3)}}}const I=76,R=43;let M=null,Q=null,x=null,E=null,_=null,v=null,C=null,L=null,b=null,S=null,z=!0;const St=window.matchMedia("(prefers-reduced-motion: reduce)").matches;function K(e){const o=n=>Math.round(Math.min(255,Math.max(0,n))).toString(16).padStart(2,"0");return`#${o(e[0])}${o(e[1])}${o(e[2])}`}function At(e){const o=e.fields.filter(a=>a.core>0),n=o.length>0?o:e.fields,i=Array.from({length:4},(a,c)=>{const s=n[c%n.length]??n[n.length-1];return s?K(s.rgb):"#000000"}),t=n.length>1?K(n[1].rgb):i[0];return{neon:i,accent:t}}function Mt(e,o){if(x&&x.width===e&&x.height===o)return x;x=document.createElement("canvas"),x.width=e,x.height=o;const n=x.getContext("2d"),i=n.createImageData(e,o);for(let t=0;t<i.data.length;t+=4){const a=128+(Math.random()-.5)*140;i.data[t]=a,i.data[t+1]=a,i.data[t+2]=a,i.data[t+3]=255}return n.putImageData(i,0,0),x}function O(e){if(!C||!L||!E)return;const o=C.width,n=C.height;M||(M=document.createElement("canvas"),M.width=I,M.height=R,Q=M.getContext("2d"));const i=Ht(E,e,I,R);Q.putImageData(new ImageData(new Uint8ClampedArray(i),I,R),0,0),L.imageSmoothingEnabled=!0,L.imageSmoothingQuality="high",L.clearRect(0,0,o,n),L.filter="blur(2px)",L.drawImage(M,0,0,I,R,0,0,o,n),L.filter="none",L.globalAlpha=.05,L.globalCompositeOperation="overlay",L.drawImage(Mt(o,n),0,0),L.globalAlpha=1,L.globalCompositeOperation="source-over"}function U(){_!=null&&(cancelAnimationFrame(_),_=null)}function F(){!St&&z&&!document.hidden&&v!=null?_==null&&(_=requestAnimationFrame(tt)):U()}function W(){if(!C||!E||!v)return;const e=v.querySelector(".hero-art-img"),o=e?e.offsetWidth:1920,n=e&&e.offsetHeight?e.offsetHeight:Math.round(o*(1080/1920));if(C.style.width=`${o}px`,C.style.height=`${n}px`,C.width=o,C.height=n,b){const i=v.querySelector(".hero-art-canvas3d");i&&(i.style.width=`${o}px`,i.style.height=`${n}px`,b.resize(o,n))}}function tt(e){const o=e/1e3;O(o),b&&b.render(o,window.scrollY),v&&!v.classList.contains("is-animated")&&v.classList.add("is-animated"),_=requestAnimationFrame(tt)}function et(){const e=document.querySelector(".hero-art");if(!e){U(),S&&(S.disconnect(),S=null),v=null,C=null,L=null,E=null,b=null;return}if(e.dataset.bound)return;e.dataset.bound="true";const o=e.getAttribute("data-art-seed");if(o==null||(v=e,E=Ct(Number(o),lt,I,R),C=e.querySelector(".hero-art-canvas"),L=C?C.getContext("2d"):null,!C||!L))return;b=null;const n=e.querySelector(".hero-art-canvas3d");if(n){const{neon:t,accent:a}=At(E);b=xt(n,t,a,.9)}S&&S.disconnect(),z=!0,S=new IntersectionObserver(t=>{z=t[0]?.isIntersecting??!0,F()});const i=e.querySelector(".hero-art-img")??e;S.observe(i),U(),W(),O(0),b&&b.render(0,window.scrollY),v.classList.add("is-animated"),F()}document.addEventListener("astro:page-load",et);document.addEventListener("visibilitychange",F);window.addEventListener("resize",()=>{v&&(W(),O(0),b&&b.render(0,window.scrollY))});et();document.addEventListener("astro:page-load",()=>{const e=document.getElementById("section-indicator"),o=document.getElementById("section-indicator-text");if(!e||!o)return;const n=Array.from(document.querySelectorAll("#main-wrapper h2, #main-wrapper h3"));if(!n.length)return;const i=document.getElementById("main-wrapper"),t=i?i.offsetTop-window.innerHeight*.6:0,a=new Set;function c(){const r=n.find(l=>a.has(l));!r||r.textContent===o.textContent||(o.style.opacity="0",setTimeout(()=>{o.textContent=r.textContent.trim(),o.style.opacity="1"},150))}const s=new IntersectionObserver(r=>{r.forEach(l=>{l.isIntersecting?a.add(l.target):a.delete(l.target)}),c()},{rootMargin:"-20% 0px -70% 0px",threshold:0});n.forEach(r=>s.observe(r));let h=window.scrollY,g=!1;function u(){const r=window.scrollY,l=r>t&&r>h;e.classList.toggle("visible",l),h=r,g=!1}function f(){g||(requestAnimationFrame(u),g=!0)}window.addEventListener("scroll",f,{passive:!0}),f()});
